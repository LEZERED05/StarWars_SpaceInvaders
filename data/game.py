...
class Game:
    BACKGROUND_IMAGE = pygame.image.load(os.path.join('images', 'background_starwars.jpg'))
    HEALTH_IMAGE = pygame.image.load(os.path.join('images', 'xwingplayer.png'))
    HEALTH_SIZE = (31, 29)
    FONT_SIZE = 26
    ...
    def __init__(self, screen, SETTINGS):
        ...
        self.score = 0
        self.font = pygame.font.Font(os.path.join('images', 'Pixeltype.ttf'), self.FONT_SIZE)
    ...
    def display_lives(self):
        for live in range(self.player.sprite.health - 1):
            position = (
            self.SETTINGS['WIDTH'] - (self.HEALTH_SIZE[1] * 2 + 25) + (live * (self.HEALTH_SIZE[1] + 10)), 10)
